...
//		String ss = "{\"data\":[{\"id\":668826,\"channel\":\"JD\",\"md_code\":\"120085\",\"product_bn\":\"800385798test\",\"prompt_price\":1860,\"prompt_code\":\"\",\"begin_time\":1411920000000,\"end_time\":1414684800000,\"bill_no\":\"\",\"prompt_type\":\"1\",\"out_prompt_id\":null,\"serial_no\":0,\"remark\":\"12345\",\"gmt_create\":1561960084533,\"gmt_modified\":1561961952392}],\"database\":\"bbg_plat_goods\",\"destination\":\"channelgoods\",\"es\":1561961952000,\"groupId\":null,\"isDdl\":false,\"old\":[{\"remark\":\"1234\",\"gmt_modified\":1561961858288}],\"pkNames\":[\"id\"],\"sql\":\"\",\"table\":\"gc_channel_prompt_product\",\"ts\":1561961953003,\"type\":\"UPDATE\"}";
...
//		String ss = "{\"data\":[{\"id\":9361,\"product_bn\":\"104248035\",\"md_code\":\"120236\",\"warehouse_id\":1001,\"channel\":\"BTGO\",\"store\":7,\"nostore\":0,\"freez\":2,\"lock\":0,\"nostore_sell\":1,\"store_type\":1,\"serial_no\":54012746,\"remark\":\"\",\"record_create_time\":1534931458000,\"record_last_modify\":1557975651000}],\"database\":\"bbg_plat_sp\",\"destination\":\"store\",\"es\":1557975651000,\"groupId\":null,\"isDdl\":false,\"old\":[{\"freez\":1,\"record_last_modify\":1547354403000}],\"pkNames\":[\"id\"],\"sql\":\"\",\"table\":\"sp_store_o2o_details\",\"ts\":1558004462493,\"type\":\"UPDATE\"}";
		String ss = "{\"data\":[{\"id\":9337,\"business_type_code\":\"002\",\"product_bn\":\"102725580A\",\"md_code\":\"120236\",\"warehouse_id\":1001,\"channel\":\"BTGO\",\"store\":99.0,\"nostore\":0.0,\"freez\":0.0,\"lock\":0.0,\"nostore_sell\":0,\"shop_nostore_sell\":0,\"store_type\":1,\"serial_no\":126,\"remark\":\"5\",\"record_create_time\":1534931458000,\"record_last_modify\":1583497355000}],\"database\":\"bbg_plat_sp\",\"destination\":\"store\",\"es\":1583497355000,\"groupId\":null,\"isDdl\":false,\"old\":[{\"product_bn\":\"102725580\",\"record_last_modify\":1583497335000}],\"pkNames\":[\"id\"],\"sql\":\"\",\"table\":\"sp_store_o2o_details\",\"ts\":1583497355847,\"type\":\"UPDATE\"}";
		Dml dml = JSON.parseObject(ss, Dml.class);
...
//		String sql = "select concat(a.channel,'_',a.md_code,'_',a.product_bn) as _id,a.id as channelProductId,a.channel,a.md_code as mdCode,a.product_bn as productBn,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.id else -1 end) as channelPromptId,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.prompt_price else -1 end) as promptPrice,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.prompt_code else -1 end) as promptCode,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.begin_time else -1 end) as beginTime,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.end_time else -1 end) as endTime,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.bill_no else -1 end) as billNo,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.prompt_type else -1 end) as promptType,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.out_prompt_id else -1 end) as outPromptId,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.serial_no else -1 end) as channelPromptSerialNo,max(case when b.prompt_type='1' and b.prompt_code!='01' then b.remark else -1 end) as channelPromptRemark from gc_channel_product a left join gc_channel_prompt_product b on a.md_code = b.md_code and a.channel = b.channel and a.product_bn = b.product_bn";
